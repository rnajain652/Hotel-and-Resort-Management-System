...
CREATE TABLE `EMPLOYEE_CONTACT` (
	...
	CONSTRAINT `EMPLOYEE_CONTACT_ibfk_1` FOREIGN KEY (`Emp_Ssn`) REFERENCES `EMPLOYEE` (`Ssn`)
)ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `HOUSEKEEPING` (
	...
	CONSTRAINT `HOUSEKEEPING_ibfk_1` FOREIGN KEY (`Ssn`) REFERENCES `EMPLOYEE` (`Ssn`),
	CONSTRAINT `HOUSEKEEPING_ibfk_2` FOREIGN KEY (`Room_served`) REFERENCES `ROOM` (`Room_number`)
)ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `WAITER` (
	...
	CONSTRAINT `WAITER_ibfk_1` FOREIGN KEY (`Ssn`) REFERENCES `EMPLOYEE` (`Ssn`)
)ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `CHEF` (
	...
	#CONSTRAINT `CHEF_ibfk_2` FOREIGN KEY (`Ssn`) REFERENCES `CHEF` (`Ssn`)
)ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `PREPARES` (
	...
	CONSTRAINT `PREPARES_ibfk_1` FOREIGN KEY (`Chef_ssn`) REFERENCES `CHEF` (`Ssn`),
	CONSTRAINT `PREPARES_ibfk_2` FOREIGN KEY (`Item_num`) REFERENCES `FOOD_ITEM2` (`Item_num`)
)ENGINE=InnoDB DEFAULT CHARSET=latin1;
